...
namespace Modder_76561198211789445.EventConfig.Taiwu.EventGroup1400fef7bec0446382eabb61aa9fc7c8
{
	...
	public class JTCXEvent_170e12a42f8943ee8f3df48b80b0a014 : TaiwuEventItem
	{
		public JTCXEvent_170e12a42f8943ee8f3df48b80b0a014()
		{
			Guid = Guid.Parse("170e12a4-2f89-43ee-8f3d-f48b80b0a014");
			IsHeadEvent = false;
		...
		public override void OnEventEnter()
		{
			...
			{
				double num3 = (double)kuaigan1 + (double)(jichu + xingfen1 / 10) * (1.0 + (double)(101 - tili1) * 0.0025 + (double)lingmin * 0.0025);
