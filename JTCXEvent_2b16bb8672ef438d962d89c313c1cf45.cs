...
namespace Modder_76561198211789445.EventConfig.Taiwu.EventGroup1400fef7bec0446382eabb61aa9fc7c8
{
	...
	public class JTCXEvent_2b16bb8672ef438d962d89c313c1cf45 : TaiwuEventItem
	{
		public JTCXEvent_2b16bb8672ef438d962d89c313c1cf45()
		{
			Guid = Guid.Parse("2b16bb86-72ef-438d-962d-89c313c1cf45");
			IsHeadEvent = false;
		...
		public override void OnEventEnter()
		{
			...
			int arg2 = 0;
			ArgBox.Get("kuaigan22", ref arg2);
			int arg3 = 0;
			ArgBox.Get("xinshen1", ref arg3);
			int arg4 = 0;
			...
			if (TaiwuEvent.GetModData("QitaXP", isArchive: true, ref val) && arg8 == 0)
			{
			...
			ArgBox.Set("xinshen1", arg3 + 2);
			ArgBox.Set("xinshen2", arg4 + 2);
			...
			int item = 1;
			if ((arg6 != 2 && kuaigan2 >= 200 && arg4 >= 100) || (arg6 == 2 && (kuaigan2 >= 100 || arg2 >= 100) && arg4 >= 100))
			{
				string val2 = "1";
				string text = "1";
			...
			int Addkuaigan2(int jichu)
			{
				...
				double num7 = (double)kuaigan2 + (double)(jichu + xingfen2 / 10) * (1.0 + (double)(101 - tili2) * 0.0025 + (double)lingmin * 0.0025);
